...
- [Installation & Usage](#installation-and-usage)
  ...
  - [Render.com (Quick Deploy)](#deploy-to-rendercom)
...
The fastest way to deploy this bot to production is using [Render.com](https://render.com). A `render.yaml` configuration file is included for easy deployment.

1. Fork this repository to your GitHub account
2. Sign up for a free account at [Render.com](https://render.com)
3. Click "New" → "Blueprint" from your Render dashboard
4. Connect your GitHub account and select your forked repository
5. Render will automatically detect the `render.yaml` file
6. You'll be prompted to enter your environment variables:
   - `DISCORD_BOT_TOKEN` - Your Discord bot token
   - `DISCORD_CLIENT_ID` - Your Discord application client ID
   - `OWNER_ID` - Your Discord user ID
   - `LAVALINK_URL` - Your Lavalink server URL (optional)
   - `LAVALINK_PASSWORD` - Your Lavalink password (optional)
7. Click "Apply" and Render will build and deploy your bot automatically
8. Your bot will be live within a few minutes!

The free tier on Render.com is perfect for testing and small communities. Your bot will automatically redeploy when you push changes to your repository.
